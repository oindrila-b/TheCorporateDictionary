  ...
  return (
    <div className='flex flex-col left-5 mt-52 text-gray-400/80 ml-28 cursor-pointer items-center'>
       <div className='text-9xl text-center items-center text-white'>
        ...
        <p className='text-ellipsis text-balance text-2xl m-6 break-words'>
          ...
          <p className='text-ellipsis text-balance text-2xl m-6 break-words'> Tech Terms content is focused on these different sections:</p>
       </div>
