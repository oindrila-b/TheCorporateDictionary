...
const Corporate = () => {
  return (
    <div className='flex flex-column min-h-screen overflow-auto justify-center bg-[conic-gradient(at_top,_var(--tw-gradient-stops))] from-gray-900 via-gray-900 to-black'>
      <Navbar />
